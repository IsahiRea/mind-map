  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="node-details-modal">
        <button className="node-details-modal-close" onClick={onClose}>
        ...
        <div className="node-details-header">
          ...
          {!isVisitorMode && (
            <div className="node-details-actions">
              <button className="node-details-edit-btn" onClick={onEdit} title="Edit node">
        ...
        <p className="node-details-modal-description">
          {isVisitorMode ? 'View learning node details' : 'View and edit learning node details'}
        </p>
